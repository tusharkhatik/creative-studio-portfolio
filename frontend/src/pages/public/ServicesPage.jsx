...
function ProjectDetails() {
  ...
  return (
    <main className="relative overflow-hidden bg-[#080a12] text-white pt-20">
      ...
      <div className="relative mx-auto max-w-[1500px] px-6 py-20 lg:px-10 lg:py-32">
        ...
        <div className="mt-16 grid gap-12 border-t border-white/10 pt-10 md:grid-cols-3">
          <div>
            <p className="text-[8px] uppercase tracking-[0.25em] text-white/25">Client</p>
            <p className="mt-3 text-sm text-white/70">{project.client || "Independent"}</p>
          </div>

          <div>
            <p className="text-[8px] uppercase tracking-[0.25em] text-white/25">Services</p>
          ...
          <div className="md:text-right">
            <p className="text-[8px] uppercase tracking-[0.25em] text-white/25">Year</p>
            <p className="mt-3 text-sm text-white/70">{project.year}</p>
          </div>
        </div>

        <div className="mt-20 flex flex-col justify-between gap-8 border-t border-white/10 pt-8 sm:flex-row sm:items-center">
          <div>
            <p className="text-[9px] uppercase tracking-[0.25em] text-white/25">Next step</p>
            <h2 className="mt-2 text-2xl font-medium">Have a project like this?</h2>
          </div>
